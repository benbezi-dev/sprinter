...
export function TouchControls() {
  ...
  return (
    <div className="absolute bottom-0 w-full portrait:h-[25vh] landscape:h-[50vh] max-h-[250px] flex px-[max(env(safe-area-inset-left),0.5rem)] pr-[max(env(safe-area-inset-right),0.5rem)] pb-[max(env(safe-area-inset-bottom),0.5rem)] gap-2 z-50 pointer-events-none">
      <div 
